<p align="center"><img width="100" src="./web/public/logo.png" alt="vva"></p>
<h1 align="center">vva</h1>
<p align="center">前端的全栈之路</p>

## ☘️ 项目简介
[vva](https://vue3.baiwumm.com/) 是一个前端基于 [Soybean Admin](https://docs.soybeanjs.cn/) 二次开发，后端基于 [Nest.js](https://nestjs.com/) 的全栈后台应用，适合学习全栈开发的同学参考学习。
...
- 🍂 线上预览： https://vue3.pup.com/

- 🍃 用户名：**Admin**，密码：**abc123456**

- [🪹 github 仓库地址](https://github.com/foolish-pup/vva-pro/)

- [🪺 码云仓库地址](https://gitee.com/foolish-pup/vva-pro/)
...
2. 拉取项目代码
```powershell
git clone https://github.com/foolish-pup/vva-pro.git
cd vue3-admin
// 进入前端
cd web
// 进入后端
...
| ![](./web/src/assets/demo/1.png) | ![](./web/src/assets/demo/2.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![](./web/src/assets/demo/3.png) | ![](./web/src/assets/demo/4.png) |

## 🍄 总结
1. 本项目没有经过严格的测试，有可能存在一定的 `Bug`。
2. 本项目仅供学习交流使用，请勿用于商业用途。
3. 欢迎提交 [Issues](https://github.com/foolish-pup/vva-pro/issues) 和 [PR](https://github.com/foolish-pup/vva-pro/pulls)，一起完善本项目。

## ⭐ Star History

[![Star History Chart](https://api.star-history.com/svg?repos=foolish-pup/vva-pro&type=Date)](https://star-history.com/#foolish-pup/vva-pro&Date)